...
public class Mask_Vec_Color_Sorter extends PApplet {
...
{
  return PApplet.parseInt(random(0, 999999));
}

public void maskVecMove(String maskString, int vecX, int vecY) {
...
public void maskVecSort(String maskString, int vecX, int vecY, boolean dir) {
...
public void maskPolSort(String maskString, int rVec, int aVec) {
  int pixelA;
  int pixelB;
  ...
  for (int i=0; i<(h*w); i++) {
    ...
    xB = PApplet.parseInt(rB * cos(aB));
    yB = PApplet.parseInt(rB * sin(aB));
...
public void maskSort(String maskString, boolean dir, boolean or) {
...
// Is A > B?
public boolean maskCompare(int A, int B, String maskString) {
  int mask = unhex(maskString);
...
public boolean onesCompare(int A, int B) {
...
public boolean brightCompare(int A, int B) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Mask_Vec_Color_Sorter" };
    if (passedArgs != null) {
